...
for (i in 1:length(folder.names)){
  ...
  for (j in 1:length(file.names)){
    ...
    jpeg(paste("./wordcloud/",folder.names[i], "/", folder.names[i],"_wordcloud_",file_path_sans_ext(file.names[j]),".jpg", sep = ""),
    ...
    dev.off()
    print(paste("Wordcloud generated ", folder.names[i], "_wordcloud_", file_path_sans_ext(file.names[j]), ".jpg saved", sep = ""))
