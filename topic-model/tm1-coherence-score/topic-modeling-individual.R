...
### load data -----------------------------------------------------------------
debate <- read_excel("./narratives/batch_1/narrative_kabbanggai_2015_bryan_verified.xlsx")

### using textmine ------------------------------------------------------------

# apply textcleaner function for review text
deb_nar_cleaned <- text_cleaner_textmine(debate$narrative, "stopwords-final.txt") 
...
nar_corp <- VCorpus(VectorSource(debate$narrative))
